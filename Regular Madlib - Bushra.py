...
Titles_and_Templates = {
    "Final Advertisement Script": "\nAre you looking for a {first adjective} {first noun}? Look no further! Our {first adjective} {first noun} is now available for only {number} {plural noun}. This {second adjective} deal won’t last long, so {first verb} now!\n\nVisit our {third adjective} store, and for a limited time, get a free {second noun} with every purchase. Our {fourth adjective} team is ready to {second verb} you with any questions.\n\nHurry, this offer ends soon!",
...
Advisory_List = {'first noun': '', 'past tense verb': '', 'first adjective': '', 'second noun': '', 'present tense verb': '', 'second adjective': '', 'third noun': '', 'third adjective': '', 'fourth adjective': ''}
...
#Select the corrct dictonary of required words to be requested, determined by the previously selected story
